...
class CNNBiLSTM(nn.Module):
    ...
    def forward(self, x, x_char, x_pos, x_lex_embedding, lengths):
        ...
        for i in range(x_char.size(1)):
            ...
            h_pools1 = [F.max_pool1d(i, i.size(2)).squeeze(2) for i in h_convs1] 
            h_pools1 = torch.cat(h_pools1, 1) 
        ...
        enhanced_embedding = torch.cat((char_output, x_word_embedding, trainable_x_word_embedding, x_pos_embedding), 2) 
