...
public class RecyclerViewAdapterRC extends RecyclerView.Adapter<RecyclerViewAdapterRC.ViewHolder> {
    private List<ReceivedMessage> mData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    public RecyclerViewAdapterRC(Context context, List<ReceivedMessage> mData) {
    ...
    @Override
    public void onBindViewHolder(RecyclerViewAdapterRC.ViewHolder holder, int position) {
        ReceivedMessage msg = mData.get(position);
    ...
    public ReceivedMessage getItem(int idx) {
